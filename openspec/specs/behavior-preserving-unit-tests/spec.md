...
Preserve the long-standing behavior of aws-sso-creds with comprehensive unit tests that support future refactoring without relying on real AWS accounts, real SSO login state, or the user's home directory.
